              ...
              <div class="flex justify-end items-center">
                <div class="flex items-center text-sm sm:text-base">
                  ...
                  <div class="mr-4 font-medium flex items-center">Hi, Noarex
                    ...
                    <a class="cursor-pointer ml-5" @click="emitLogOut">
      ...
      <div :class="mobile_nav ? 'block' : 'hidden md:block'" class="fixed z-0 pt-4 md:pt-0 -mt-1 md:top-14 lg:top-16 h-full md:h-auto w-10/12 md:w-full bg-primary-100 px-2 text-white md:block">
        <div class="mx-auto md:container">
          ...
          <div class="pt-16 md:pt-0 md:flex justify-start">
            ...
            <nuxt-link :to="{name:'admin-admin-courses'}" :class="isUrl('admin-courses') ? (active_nav + nav_item) : nav_item">Courses</nuxt-link>
            <nuxt-link :to="{name:'admin-tagsandcategories'}" :class="isUrl('tagsandcategories') ? (active_nav + nav_item) : nav_item">Statistics</nuxt-link>
